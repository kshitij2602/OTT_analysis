...
# Function to process and create line charts for each genre
def process_and_visualize_genre_line_charts():
    ...
    if all_data:
        ...
        output_path = '/home/dishant/de_project/airflow_venv/genre_line_charts.png'
...
# DAG definition
with DAG(
    dag_id='process_and_visualize_genre_line_charts_dag',
    default_args=default_args,
    description='A simple DAG to visualize genre data as line charts',
    schedule_interval=None,  # Set to None to run manually or specify interval
    catchup=False,
) as dag:

    # Task to process and visualize genre line charts
    visualize_genre_task = PythonOperator(
        task_id='process_and_visualize_genre_line_charts',
        python_callable=process_and_visualize_genre_line_charts,
        dag=dag,
    )

    # Set the task sequence (if any)
    visualize_genre_task
